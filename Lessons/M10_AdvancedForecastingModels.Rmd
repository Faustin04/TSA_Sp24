...
=======
>>>>>>> 56af01cf296d8ad92279fd9165cbc867b9e926de
...
* TBATS
* Neural Network (is ARIMA with non linear model) 
...
<<<<<<< HEAD
                            start=c(2006,12,16)) #specificity for hourly data
=======
...
ARIMA_Four_fit <- auto.arima(ts_act_power_daily_train, 
                             seasonal=FALSE, #SARIMA doesnt handle seasonality.
                             lambda=0,
                             xreg=fourier(ts_act_power_daily_train,  #fourier finds best fit of the model.
                                          K=c(2,12)) #the less K the simpler. 
                             #2 stands for the weekly and weekend 
                             #12 stands for the number of the yearly seasons we need. it must be even.
                             )

#Forecast with ARIMA fit (bcz autoarima doesn't give the forcast, it only gives the best fit)
